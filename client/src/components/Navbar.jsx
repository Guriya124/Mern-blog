...
export default function Navbar() {
    ...
    return (
        <nav className="p-3 flex items-center justify-between border-b bg-white dark:bg-gray-900 ">
            {/* Logo and Title */}
            <Link to="/" className="flex items-center space-x-2 text-sm sm:text-xl font-semibold dark:text-white">
            ...
            <div className={`lg:flex lg:items-center lg:space-x-6 ${isOpen ? 'block absolute top-16 right-0 bg-gray-50 border-b w-full dark:bg-gray-800 lg:static lg:top-0 lg:right-auto' : 'hidden'} lg:ml-6`}>
